...
export const tokenizerBinaryConfig = {
  ...
  "__section_13": "══════════════════════════════════════════════════════════════════════════════",
  "__section_13_number": "13",
  "__section_13_title": "【SECTION 13】Language-Specific Keywords & Operators",
  "__section_13_languages": [
    "Java",
    "JavaScript",
    "TypeScript",
    "JSX"
  ],
  "__section_13_description": "Complete Keyword Sets for Java, JavaScript, TypeScript, JSX",
  "__section_13_purpose": "กำหนด keywords และ operators ที่เฉพาะเจาะจงแต่ละภาษา เช่น 'async/await' (JS), 'record' (Java), 'keyof' (TS)",
  "__section_13_responsibility": "ให้ GrammarIndex (Brain) รู้จัก keywords, operators, built-in objects แต่ละภาษาเพื่อ classify tokens ได้ถูกต้อง",
  "__section_13_used_by": [
    "GrammarIndex",
    "KeywordRecognizer",
    "OperatorMatcher"
  ],
  "__section_13_footer": "══════════════════════════════════════════════════════════════════════════════",
  "languageKeywords": {
    "description": "Comprehensive keyword collections for supported languages - NO_HARDCODE",
    "java": {
      "language": "Java",
      "version": "SE 21",
      "totalKeywords": 68,
    ...
    "builtInObjects": {
      "description": "Built-in global objects and constructors - shared across JavaScript/TypeScript",
      "javascript": [
        "Object",
        "Array",
        "String",
    ...
    "commonIdentifiers": {
      "description": "Common variable names and identifiers that appear frequently in code",
      "variableNames": [
        "i",
        "j",
        "k",
  ...
  "languageOperators": {
    "description": "Complete operator sets for supported languages - NO_HARDCODE",
    "java": {
      "arithmetic": [
        "+",
        "-",
  ...
  "stringEscapeSequences": {
    "description": "Escape sequences for string literals - NO_HARDCODE compliance",
    "commonEscapes": {
      "description": "Common escape sequences shared across languages",
      "sequences": {
        "\\n": {
          "code": 10,
          "name": "LINE_FEED",
    ...
    "javascriptEscapes": {
      "description": "JavaScript/TypeScript specific escape sequences",
      "additional": {
        "\\v": {
          "code": 11,
          "name": "VERTICAL_TAB",
        ...
        "\\x": {
          "pattern": "\\xHH",
          "description": "Hexadecimal escape (2 digits)"
        },
        "\\u": {
          "pattern": "\\uHHHH",
          "description": "Unicode escape (4 digits)"
        },
        "\\u{}": {
          "pattern": "\\u{H+}",
        ...
        "\\$": {
          "code": 36,
          "name": "DOLLAR",
          "description": "Dollar sign (in template literals)"
        }
      }
    },
    "javaEscapes": {
      "description": "Java specific escape sequences",
      "sequences": {
        "\\u": {
          "pattern": "\\uHHHH",
          "description": "Unicode escape (4 digits only)"
        }
      }
    },
    "regexEscapes": {
      "description": "Regular expression escape sequences",
      "metacharacters": [
        ".",
        "*",
        "+",
